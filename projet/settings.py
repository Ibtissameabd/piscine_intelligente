...
SECRET_KEY = 'django-insecure-ol74&btu1&v9s*vxsx-o_ece($bx0@d=qu$7-qs%6f#vpz2v%9'
...
EMAIL_HOST_USER = "ibtissam.abdoussi.23@ump.ac.ma" # ⚠ ton adresse Gmail
EMAIL_HOST_PASSWORD = "qkdi ckdj nnhe ebvy"# pas ton vrai mot de passe !
